    ...
    <>
      ...
      >
        <Image
          src={pageSwitch}
          alt="Amir"
          className="w-full h-full lg:hidden md:inline-block md:w-full z-40 aspect-auto "
          priority
        />
      </motion.div>
      ...
      >
        {/* <Image
          src={picSwitch}
          alt="Amir"
          className="w-full h-full lg:hidden md:inline-block md:w-full z-30 aspect-auto"
          priority
        /> */}
      </motion.div>
      ...
      >
        {/* <Image
          src={switchPic}
          alt="Amir"
          className="w-full h-full lg:hidden md:inline-block md:w-full z-20 aspect-auto"
          priority
        /> */}
      </motion.div>
    </>
